...
function load_form(param) {
   ...
   form.push({ "id": "", "type": "text", "description": "", "values": ["Consuntivo", "Preventivo", "Consuntivo"], "styles": ["header"] });
   form.push({ "id": "", "type": "text", "description": "", "values": [param.currentYear, param.currentYear, param.previousYear], "styles": ["header"] });
