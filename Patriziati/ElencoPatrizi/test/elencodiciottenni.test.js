...
// @id = ch.banana.app.patriziato.elencodiciottenni.test
// @api = 1.0
// @pubdate = 2018-04-09
// @publisher = Banana.ch SA
// @description = <TEST ch.banana.app.patriziato.elencodiciottenni.js>
// @task = app.command
// @doctype = *.*
// @docproperties = 
// @outputformat = none
// @inputdataform = none
// @includejs = ../elencodiciottenni.js
// @timeout = -1
...
Test.registerTestCase(new ReportElencoDiciottenni());

// Here we define the class, the name of the class is not important
function ReportElencoDiciottenni() {

}

// This method will be called at the beginning of the test case
ReportElencoDiciottenni.prototype.initTestCase = function() {

}

// This method will be called at the end of the test case
ReportElencoDiciottenni.prototype.cleanupTestCase = function() {

}

// This method will be called before every test method is executed
ReportElencoDiciottenni.prototype.init = function() {

}

// This method will be called after every test method is executed
ReportElencoDiciottenni.prototype.cleanup = function() {

}

ReportElencoDiciottenni.prototype.testReport = function() {
   
  Test.logger.addComment("Test ch.banana.app.patriziato.elencodiciottenni.js");
  ...
  Test.logger.addSection("Elenco diciottenni tests");

  // 1.
  Test.logger.addSubSection("Test 1: Elenco diciottenni anno 2015");
  aggiungiReportElencoDiciottenni("Test 1", banDoc, "2015");

  //2.
  Test.logger.addSubSection("Test 2: Elenco diciottenni anno 1970");
  aggiungiReportElencoDiciottenni("Test 2", banDoc, "1970");

}

//Function that creates the report for the test
function aggiungiReportElencoDiciottenni(reportName, banDoc, year) {
  var report = printCard(banDoc, year);
